...
Public Class clsErrorHandler
    ...
    Public Sub _Err(Profile As objProfile, Where As String, What As String, objEx As Exception, Display As Boolean, Notify As Boolean, Log As Boolean)
        ...
        sbProfile.AppendLine("SQLConnectionStr: " & Profile.p_SQLConnectionStr)
        ...
        If Notify Or Log Then
            ...
            cn = New SqlConnection("Server=SRV-1LD2SQL01;Database=sdPack;User Id= SuperD")
            ...
            Try
                ...
                With Profile
                    ...
                    params.Add("@ErrMessage", objEx.Message)
    ...
    Private Sub SendMail(ByVal ProfileStr As String, AppName As String, ComputerName As String, SQLEx As Exception, OriginalEx As String, Display As Boolean)
        ...
        Dim MailMsg As New MailMessage(New MailAddress("gregb@sdcd.com"), New MailAddress("gregb@sdcd.com"))
        ...
        With smtp
            ...
            'TODO: need dedicated err account
            '.Credentials = New System.Net.NetworkCredential("gregb", "LeTmEin57")
...
#Region "Properties"
    ...
    Public Property p_SQLConnectionStr() As String
    Public Property p_WaveNmbr() As String
